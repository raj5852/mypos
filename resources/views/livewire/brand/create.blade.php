<div>
    <div class="card">
        <div class="card-header"><h3>New Brand</h3> </div>
        <div class="card-body">
            <form wire:submit.prevent="brandstore">
                ...
                <div>
                    <button wire:loading.attr="disabled" wire:target="brandstore" type="submit"
                        class="btn btn-primary">
                        Submit
                        <div wire:loading wire:target="brandstore" class="spinner-border spinner-border-sm"
                            role="status">
